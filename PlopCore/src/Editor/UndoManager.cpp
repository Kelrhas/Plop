...
namespace Plop
{
	...
	void UndoManager::Undo()
	{
		if (CanUndo())
		{
			...
			ASSERTM(func, "The undo commands for action type {} was not defined", (std::size_t)action.m_eType);
			if (func)
			{
	...
	void UndoManager::Redo()
	{
		if (CanRedo())
		{
			...
			ASSERTM(func, "The redo commands for action type {} was not defined", (std::size_t)action.m_eType);
			if (func)
			{
				if (func(action.m_data))
				{
